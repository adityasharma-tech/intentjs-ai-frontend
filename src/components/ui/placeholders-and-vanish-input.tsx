  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        value={value}
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20 pt-5",
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-4 bottom-4 z-50 px-3 py-2 rounded-xl disabled:opacity-50 disabled:border-white/10 border-neutral-800 border bg-black dark:bg-zinc-900 dark:disabled:bg-zinc-800 transition duration-200 flex items-center justify-center"
      >
